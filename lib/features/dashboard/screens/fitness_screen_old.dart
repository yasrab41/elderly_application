...
class FitnessScreen2 extends StatelessWidget {
  const FitnessScreen2({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: CustomScrollView(
        slivers: [
          SliverAppBar(
            backgroundColor: Colors.transparent, // Purple-blue for the app bar
            expandedHeight: 200.0,
            floating: false,
            pinned: true,
            shadowColor: const Color(0xFF48352A),
              ...
              background: Container(
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    colors: [const Color(0xFF48352A), const Color(0xFF7B6658)],
                      ...
                      Card(
                        ...
                        child: Container(
                          decoration: BoxDecoration(
                            gradient: LinearGradient(
                              colors: [
                                const Color.fromARGB(255, 122, 93, 75),
                                const Color.fromARGB(255, 156, 130, 112)
                              ],
                              begin: Alignment.topLeft,
                              end: Alignment.bottomRight,
                            ),
